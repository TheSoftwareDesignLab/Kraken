...
When('I navigate to page {kraken-string}', async function (this: any, page: any) {
    return await this.driver.url(page);
});

When('I click view with selector {kraken-string}', async function (this: any, selector: any) {
    let element = await this.driver.$(selector);
    return await element.click();
});

When('I enter text {kraken-string}', async function (this: any, text: any) {
    return await this.driver.keys(text);
});

When('I click first view with selector {kraken-string}', async function (this: any, selector: any) {
